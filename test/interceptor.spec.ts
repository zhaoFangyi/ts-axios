...
describe('interceptors', () => {
  ...
  test('should add a request interceptors', () => {
    ...
    instance.interceptors.request.use(config => {
      config.headers.test = 'added by interceptors'
      return config
    })
    ...
    return getAjaxRequest().then(request => {
      expect(request.requestHeaders.test).toBe('added by interceptors')
    })
  })

  test('should add a request interceptors that returns a new config object', () => {
    const instance = axios.create()
  ...
  test('should add a request interceptors that returns a promise', done => {
    const instance = axios.create()
  ...
  test('should add a response interceptors that return a new data objet', done => {
  ...
  test('should add a response interceptors that return a promise', done => {
    let response: AxiosResponse
    const instance = axios.create()
